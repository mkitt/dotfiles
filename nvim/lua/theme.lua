...
M.apply = function(theme)
    local highlights = {
        ...
        Boolean = { fg = theme.base0F },
        Comment = { fg = theme.base03 },
        Constant = { fg = theme.base07 },
        Number = { fg = theme.base0F },
        Float = { link = 'Number' },
        String = { fg = theme.base0E },
        Character = { link = 'String' },
        Identifier = { fg = theme.base08 },
        Function = { fg = theme.base08 },
        Statement = { fg = theme.base09 },
        Conditional = { fg = theme.base09 },
        Repeat = { fg = theme.base09 },
        Label = { fg = theme.base09 },
        Operator = { fg = theme.base09 },
        Keyword = { fg = theme.base09 },
        Exception = { fg = theme.base09 },
        PreProc = { fg = theme.base0A },
        Include = { fg = theme.base0A },
        Define = { fg = theme.base0A },
        Macro = { fg = theme.base0A },
        PreCondit = { fg = theme.base0A },
        Type = { fg = theme.base07 },
        StorageClass = { fg = theme.base07 },
        Structure = { fg = theme.base07 },
        Typedef = { fg = theme.base07 },
        Special = { fg = theme.base0F },
        SpecialChar = { fg = theme.base0F },
        SpecialComment = { fg = theme.base0F },
        Delimiter = { fg = theme.base04 },
        Tag = { fg = theme.base09 },
        Debug = { fg = theme.base0C },
        Underlined = { underline = true },
        Ignore = { fg = theme.base08 },
        Error = { fg = theme.base0B },
        Todo = { fg = theme.base0C, underline = true },
